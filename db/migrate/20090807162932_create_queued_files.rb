class CreateQueuedFiles < ActiveRecord::Migration
  def self.up
    ...
    execute "ALTER TABLE queued_files ADD CONSTRAINT fk_pasokara_files FOREIGN KEY (pasokara_file_id) REFERENCES pasokara_files(id)"
  end

  def self.down
    execute "ALTER TABLE queued_files DROP FOREIGN KEY fk_pasokara_files"
